...
class uploadBusinessPhotos extends StatefulWidget {
  const uploadBusinessPhotos({super.key});

  @override
  State<uploadBusinessPhotos> createState() => _uploadBusinessPhotosState();
}

class _uploadBusinessPhotosState extends State<uploadBusinessPhotos> {
  var imageFile;
  @override
                          ...
                          child: CustomPadding(
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomText(
                                  text:
                                      'Upload business photes for your business the',
                                  fontSize: 15,
                                ),
                                CustomText(
                                  text:
                                      'Atleast 3 images (Size:540*540 Pixels)',
                                  fontSize: 15,
                                  color: Colors.grey,
                                ),
                                CustomSizedBox(height: 0.02, width: 0),
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        if (imageFile == null) {
                                          ...
                                          Appconstant.businessImg =
                                              imageFile.path.toString();
                                              await uploadImage(imageFile.path); 
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => uploadHeader(),
                                              ));
                                        }
                                      },
                                    )
